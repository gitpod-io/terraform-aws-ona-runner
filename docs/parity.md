...
| Private ECR release template | private `runner_image`, `proxy_image`, `adot_image`, and `metrics_audit_sync_image` | Derived runner update prefix without a Terraform-only input |
